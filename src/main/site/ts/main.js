...
const dropDownSun = document.querySelector('#sun');
const dropDownMoon = document.querySelector('#moon');
const dropDownRising = document.querySelector('#rising');
...
document.addEventListener("keyup", () => __awaiter(void 0, void 0, void 0, function* () {
    yield updateValues("Scorpio", "Gemini", "Scorpio");
    postAndUpdate();
}));
